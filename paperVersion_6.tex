...
\author[1]{\normalsize Carolina Barreto}
\author[2]{\normalsize Andrea Calderon}
\author[3]{\normalsize Andrea Blanco}

\affil[1,2,3]{\small Departamento de Ingenieria Industrial, Universidad de los Andes\\
...
% Date and time: jue., jun. 28, 2018 - 7:40:33 p. m.
